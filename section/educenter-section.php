							...
							<div class="ed-slider-info">
								...
								<?php if( $slider->button_text || $slider->button_url ){ ?>
									<a class="slider-button ed-button" href="<?php echo esc_url( $slider->button_url ); ?>" class="btn primary">
										<?php echo esc_html( $slider->button_text ); ?><i class="fa fa-angle-double-right"></i>
									</a>
								<?php } ?>
	...
	*/
	function educenter_calltoaction_section() { 
		...
		if( !empty( $cta ) && $cta == 1 ){ 
			...
			$button_text = get_theme_mod('educenter_cta_button_text');
...
if ( ! function_exists( 'educenter_counter_section' ) ) :
	...
	*/
	function educenter_counter_section() { 
		...
		$counter = get_theme_mod( 'educenter_courses_section_area_options', 1 );

		if( !empty( $counter ) && $counter == 1 ){ ?>

			<section class="ed-counter layout-1" style="background-image: url(<?php echo esc_url( get_theme_mod('educenter_counter_bg_image') ); ?>); background-attachment: fixed; background-size: cover;">
				
				<div class="ed-overlay"></div>	

				<div class="container">
					<div class="ed-counter-wrap layout-1">
						<?php
						...
						?>
							<div class="ed-col">
								<div class="ed-icon-holder">
									<i class="fa <?php echo esc_attr( $count->counter_icon ); ?>"></i>
								</div>

								<div class="ed-text-holder">
									<span class="counter">
										<?php echo esc_attr( $count->counter_number ); ?>
									</span>
									<span class="ed-text-header"><?php echo esc_html( $count->counter_title ); ?></span>
								</div>
							</div>
...
if ( ! function_exists( 'educenter_courses_section' ) ) :
	...
	*/
	function educenter_courses_section() { 
		...
		$courses = get_theme_mod( 'educenter_counter_section_area_options', 1 );
									...
									<div class="ed-col ed-col-three">
										...
										<div class="ed-text-holder">
											...
											<div class="ed-header-col">
												...
												<span><?php echo esc_attr( $course->course_price ); ?></span>
