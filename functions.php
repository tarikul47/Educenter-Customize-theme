...
if ( ! function_exists( 'educenter_setup' ) ) :
	...
	function educenter_setup() {
		...
		*/
		...
		add_image_size('educenter-gallery', 380, 290, true);
		add_image_size('educenter-team', 400, 500, true);
...
function educenter_scripts() {
	...
	*/
	...
	/**
	 * Load Superfish CSS Library File
	*/
	wp_enqueue_style( 'superfish', get_template_directory_uri() . '/assets/library/superfish/css/superfish.css' );
    ...
    */
    ...
    /**
     * Load Superfish JavScript Library File
    */
    wp_enqueue_script('superfish', get_template_directory_uri() . '/assets/library/superfish/js/superfish.js', array('jquery'), '1.7.9', true );
